...
import ${package}.dao.BaseUserDao;
import ${package}.dao.BaseUserLoginDao;
import ${package}.entity.User;
import ${package}.entity.UserLogin;
...
public class CoreUserServiceImpl extends BaseService implements CoreUserService {
    ...
    @Value("${symbol_dollar}{userService.invalidDays}")
    private int invalidDays = 30;

    @Value("${symbol_dollar}{userService.errLimits}")
    private short errLimits = (short) 5;

    @Value("${symbol_dollar}{userService.clearPwdLockErrIntervalInHours}")
